...
export default function App() {
  ...
  useEffect(() => {
    const makeBob = (val: Animated.Value, delay: number, range: number) =>
      Animated.loop(Animated.sequence([
        Animated.delay(delay),
        Animated.timing(val, { toValue: -range, duration: 900, easing: Easing.inOut(Easing.quad), useNativeDriver: true }),
        Animated.timing(val, { toValue: 0, duration: 900, easing: Easing.inOut(Easing.quad), useNativeDriver: true }),
      ]));
    const anims = [makeBob(coinA, 0, 4), makeBob(coinB, 300, 5), makeBob(coinC, 600, 3), makeBob(billA, 150, 4), makeBob(billB, 450, 5)];
        ...
        {screenMode === 'jar' ? (
          <>
            <View style={styles.card}>
              ...
              <Text style={styles.subtitle}>Watching {getPeriodLabel(selectedMonthKey)}. The jar empties as you spend.</Text>
              <View style={styles.jarWrap}>
                ...
                <View style={styles.jarGlass}>
                  ...
                  <Animated.View style={[styles.jarBill, styles.jarBillLeft, { transform: [{ translateY: billA }, { rotate: '-8deg' }] }]}>
                    <Text style={styles.jarBillText}>₪</Text>
                  </Animated.View>
                  <Animated.View style={[styles.jarBill, styles.jarBillRight, { transform: [{ translateY: billB }, { rotate: '6deg' }] }]}>
                    <Text style={styles.jarBillText}>₪</Text>
                  </Animated.View>
                  <Animated.View style={[styles.jarCoin, { bottom: 60, left: 30, transform: [{ translateY: coinA }] }]}>
                    <Text style={styles.jarCoinText}>₪</Text>
                  </Animated.View>
                  <Animated.View style={[styles.jarCoin, { bottom: 90, right: 28, transform: [{ translateY: coinB }] }]}>
                    <Text style={styles.jarCoinText}>₪</Text>
                  </Animated.View>
                  <Animated.View style={[styles.jarCoin, { bottom: 45, left: 80, transform: [{ translateY: coinC }] }]}>
                    <Text style={styles.jarCoinText}>₪</Text>
                  </Animated.View>
                </View>
              </View>
...
const styles = StyleSheet.create({
  ...
  jarBillLeft: { left: 18, bottom: 120 },
  jarBillRight: { right: 18, bottom: 160 },
